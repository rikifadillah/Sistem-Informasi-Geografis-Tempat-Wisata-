...
<html lang="id">
  ...
  <body>
    ...
    <footer class="footer bg-success">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> Sistem Informasi Geografis | Repost by <a href='https://stokcoding.com/' style="color: red;" title='StokCoding.com' target='_blank'>StokCoding.com</a>
         <em class="pull-right">Juni 2019</em></p>
      </div>
    </footer>
